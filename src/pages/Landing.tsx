  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <Card
          key={"261df03a-22b5-48e5-9080-015a2e5895d1"}
          title="UI Showdown"
        ...
        />
        <Card
          key={"32e25736-e688-4829-a33f-72053ba8ac26"}
          title="Bug Busters"
        ...
        />
        <Card
          key={"f32a4b61-a527-44b7-97dc-5d807a31b130"}
        ...
        />
        <Card
          key={"305d227b-5ab0-457a-b0e4-d727c85ac7ad"}
        ...
        />
        <Card
          key={"cb06bf49-f8d1-4281-8b2d-079e1447703b"}
        ...
        />
        <Card
          key={"8ab839a5-0b6a-4791-9742-d099677d5062"}
        ...
        />
        <Card
          key={"cc71840b-59cf-4e85-8e80-e42dd4e7d55a"}
          title="Brand Hunt"
        ...
        />
        <Card
          key={"6cdd1ecb-af3b-4045-b183-6646e07a3c1e"}
        ...
        />
        <Card
          key={"019789e7-7a8a-488c-b145-c4c217387d2b"}
          title="Brain Battle"
